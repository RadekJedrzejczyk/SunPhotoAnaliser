...
def generate_random_date(start_year=2011, end_date=datetime.today()):
...
def generate_image_url(date_str, hour, minute, second,quality=1024):
...
random_dates = [generate_random_date() for _ in range(420)]


# Ustawienia
NUM_THREADS = 32  # Liczba równoczesnych pobrań (dostosuj do swojego łącza)
